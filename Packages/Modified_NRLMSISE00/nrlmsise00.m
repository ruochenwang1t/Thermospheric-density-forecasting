%--------------------------------------------------------------------------
%
% Density_nrlmsise00.m
%
% Purpose:
%   Computes the atmospheric density using nrlmsise00 model
%
% Inputs:
%   input    struct('year',0,'doy',0,'sec',0,'alt',0,'g_lat',0,'g_long',
%                   0,'lst',0,'f107A',0,'f107',0,'ap',0,'ap_a',ap);
...
% 
% -------------------------------------------------------------------------
function [dens] = nrlmsise00(input, flags)
...
[~, output.t(2)] = densu(z,1.0, tinf, tlb, 0.0, 0.0,output.t(2),ptm(6), s, mn1, zn1, meso_tn1, meso_tgn1);
